...
public class WriteCommentActivity extends AbstractWriteActivity<ItemBean> {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (msg == null) {
			commentDraftBean = (CommentDraftBean) getIntent()
					.getSerializableExtra("draft");
		...
		getEditTextView().setHint(
				"@" + msg.getUser().getScreen_name() + "£º" + msg.getText());
	...
	protected ItemBean sendData() throws WeiboException {
		if (!enableRepost.isChecked()) {
			CommentNewMsgDao dao = new CommentNewMsgDao(token, msg.getId(),
					((EditText) findViewById(R.id.status_new_content))
							.getText().toString());
			if (enableCommentOri.isChecked()) {
