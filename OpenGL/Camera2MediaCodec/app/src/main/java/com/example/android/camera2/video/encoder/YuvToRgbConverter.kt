...
package com.example.android.camera2.video.encoder;
...
//from https://github.com/alexcohn/camera-samples/blob/master/CameraXTfLite/utils/src/main/java/com/example/android/camera/utils/YuvToRgbConverter.kt
/**
