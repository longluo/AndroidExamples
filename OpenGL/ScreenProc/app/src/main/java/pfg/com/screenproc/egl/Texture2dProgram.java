...
public class Texture2dProgram {
    ...
    public Texture2dProgram(ProgramType programType) {
        ...
        MyLog.logd(TAG, "Created program " + mProgramHandle + " (" + programType + ")");
     ...
     */
    public void release() {
        MyLog.logd(TAG, "deleting program " + mProgramHandle);
    ...
    public void setKernel(float[] values, float colorAdj) {
        ...
        //MyLog.logd(TAG, "filt kernel: " + Arrays.toString(mKernel) + ", adj=" + colorAdj);
    }
    ...
    public void setTexSize(int width, int height) {
        ...
        //MyLog.logd(TAG, "filt size: " + width + "x" + height + ": " + Arrays.toString(mTexOffset));
    }
