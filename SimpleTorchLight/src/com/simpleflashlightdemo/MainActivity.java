...
public class MainActivity extends Activity implements SurfaceHolder.Callback {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (context.getPackageManager().hasSystemFeature(
			...
			surfaceView = (SurfaceView) this
					.findViewById(R.id.hiddenSurfaceView);
	...
	public void showDialog(Context context, int dialogId) {
		...
		case FLASH_NOT_SUPPORTED:
			...
			builder.setMessage(
					"Sorry, Your phone does not support Camera Flash")
					.setCancelable(false)
		...
		case FLASH_TORCH_NOT_SUPPORTED:
			builder = new AlertDialog.Builder(context);
			builder.setMessage(
					"Sorry, Your camera flash does not support torch feature")
					.setCancelable(false)
					.setNeutralButton("Close", new OnClickListener() {
